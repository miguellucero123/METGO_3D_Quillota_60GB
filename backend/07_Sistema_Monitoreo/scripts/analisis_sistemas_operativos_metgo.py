...
# -*- coding: utf-8 -*-
"""
Análisis de Sistemas Operativos METGO_3D
...
def analizar_sistemas_operativos():
    print('=' * 100)
    ...
    # 6. SISTEMAS DE REPORTES
    print('6. SISTEMAS DE REPORTES')
    print('-' * 50)
    sistemas_reportes = [
    ...
    print('ESPECIFICACION: Generacion automatica de reportes')
    print('IMPLEMENTACION:')
    for sistema in sistemas_reportes:
        if os.path.exists(sistema):
            size = os.path.getsize(sistema) / 1024
            print(f'  OPERATIVO: {sistema} ({size:.1f} KB)')
        else:
    ...
    print('FUNCIONALIDADES:')
    print('  - Reportes automaticos')
    print('  - Analisis economico')
    print('  - Chatbot asistente')
    print('  - Exportacion de datos')
    print()

    # 7. DASHBOARDS HTML
    print('7. DASHBOARDS HTML')
    print('-' * 50)
    ...
    # 8. BASES DE DATOS OPERATIVAS
    print('8. BASES DE DATOS OPERATIVAS')
    print('-' * 50)
    ...
    # 9. SISTEMAS OPERATIVOS POR ESTADO
    print('9. ESTADO DE OPERATIVIDAD')
    print('-' * 50)
    ...
    for sistema in sistemas_funcionando:
        if os.path.exists(sistema):
            ...
            print(f'  ❌ {sistema} - NO ENCONTRADO')
    
    print()
    print('SISTEMAS CON PROBLEMAS IDENTIFICADOS:')
    for sistema in sistemas_con_problemas:
        if os.path.exists(sistema):
            print(f'  ⚠️ {sistema} - REQUIERE CORRECCION')
        else:
            print(f'  ❌ {sistema} - NO ENCONTRADO')
    
    print()

    # 10. RECOMENDACIONES POR ESPECIFICACION
    print('10. RECOMENDACIONES POR ESPECIFICACION')
    print('-' * 50)
    ...
    print('  - Usar: dashboard_principal_integrado_metgo.py')
