...
MODULOS_SISTEMA: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "nombre": "Portal ejecutivo Streamlit",
        "categoria": "streamlit",
        "modulo_num": "04",
        "descripcion": "Consola ejecutiva interna con salud, modelos, datos y accesos controlados.",
        "utilidad": "Portal operativo interno: salud, modelos, datos y legacy controlado.",
        ...
        "deprecado": False,
        "migrado_vue": "/",
        "nota_deprecacion": "Portal interno; la experiencia principal para usuarios finales vive en Vue/Netlify.",
    },
    {
        "id": "meteo_streamlit",
        "nombre": "Análisis meteorológico legado",
        "categoria": "streamlit",
        "modulo_num": "01",
