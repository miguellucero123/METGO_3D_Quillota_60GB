<template>
  <div class="page">
    <header class="page-head">
      ...
      <p>
        Campo de concentración + viento + terreno — proxy innovador tipo AERMOD/CALPUFF para
        {{ site.faena?.nombre || site.siteLabel }} (sitio {{ site.sitio }})
      </p>
    </header>
...
async function cargar() {
  ...
  stopPlay()
  try {
    modelo.value = await fetchAirshedModel({ sitio: site.sitio, nx: 28, ny: 28, frames: 6 })
    frameIdx.value = 0
  } catch (e) {
