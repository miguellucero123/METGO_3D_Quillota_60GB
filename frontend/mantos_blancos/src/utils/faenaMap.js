/**
 * Helpers mapa airshed Mantos Blancos (viento + plumas simplificadas).
 */
...
/** Estilo satelital + relieve (faena Mantos Blancos). */
export const MAP_STYLE_SATELLITE = {
  version: 8,
  name: 'metgo-mantos-sat',
  glyphs: 'https://demotiles.maplibre.org/font/{fontstack}/{range}.pbf',
  sources: {
    sat: {
      type: 'raster',
