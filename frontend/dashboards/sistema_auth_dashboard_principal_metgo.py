...
# Función de autenticación (variables de entorno vía metgo_auth)
def verificar_credenciales(usuario, contraseña):
    ...
    try:
        ...
        from metgo_auth import verificar_credenciales as _verificar
        return _verificar(usuario, contraseña)
    except ImportError:
