    ...
    <main class="commercial-wrap">
      <section class="commercial-hero">
        ...
        <div style="display: flex; gap: 1rem; justify-content: center;">
          <router-link to="/contacto?sector=izaje" class="commercial-btn primary">
            Solicitar piloto gratuito 30 días
          </router-link>
        </div>
      </section>
        ...
        <div class="commercial-grid-2">
          ...
          <div class="demo-card">
            ...
            <div class="traffic-light-grid">
              <div class="tl-hour">
                <span>08:00</span>
                <div class="tl-status green" title="<26 km/h">Viento calmo</div>
              </div>
              <div class="tl-hour">
                <span>09:00</span>
                <div class="tl-status green" title="<26 km/h">Viento calmo</div>
              ...
              <div class="tl-hour">
                <span>11:00</span>
                <div class="tl-status red" title=">35 km/h">Parada por norma</div>
              </div>
              <div class="tl-hour">
                <span>12:00</span>
                <div class="tl-status red" title=">35 km/h">Parada por norma</div>
