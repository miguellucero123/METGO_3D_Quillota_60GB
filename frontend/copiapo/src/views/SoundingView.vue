<template>
  <div class="page">
    <header class="page-head">
      ...
      <p>Perfil vertical Open-Meteo (proxy MetPy) · estación airshed</p>
    </header>
...
import { fetchSounding } from '@/services/aireApi'

use([CanvasRenderer, LineChart, GridComponent, TooltipComponent, LegendComponent])

const site = inject('site')
const slug = ref(site.stations?.[1]?.slug || site.stations?.[0]?.slug || 'paipote')
