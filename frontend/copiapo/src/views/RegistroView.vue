...
const planes = ref([])
const brandName = computed(() => site.siteLabel || 'Copiapó')
...
<template>
  <div class="auth-page">
    <div class="auth-panel wide">
      ...
      <template v-else>
      <div class="brand">
        <div class="logo"><Wind aria-hidden="true" /></div>
...
.auth-page {
  ...
  padding: 1.5rem;
  background: #0b1120;
  background-image: radial-gradient(ellipse 800px 400px at 10% 0%, rgba(251, 191, 36, 0.16), transparent 55%);
}
.auth-panel {
  width: min(640px, 100%);
  background: #111827;
