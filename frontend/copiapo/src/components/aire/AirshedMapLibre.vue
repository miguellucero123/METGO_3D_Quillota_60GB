...
const ariaLabel = computed(() => {
  ...
  return `Mapa geográfico del airshed de Copiapó con ${n} estaciones, modo ${props.modo}`
})
...
<style>
/* Marcadores fuera de scoped (MapLibre mueve el nodo al contenedor del mapa) */
.ml-marker {
  position: relative;
  width: 28px;
  height: 28px;
...
.ml-marker--active .ml-marker__dot {
  ...
  box-shadow: 0 0 0 3px rgba(16, 185, 129, 0.55), 0 0 12px rgba(16, 185, 129, 0.45);
}
.ml-marker__wind {
  position: absolute;
  left: 50%;
