      ...
      <section class="commercial-section">
        <div class="commercial-grid-2">
          <div>
            ...
            <div style="background: rgba(0, 255, 170, 0.05); border: 1px solid rgba(0, 255, 170, 0.2); padding: 1rem; border-radius: 8px; margin-top: 2rem;">
          ...
          <div class="demo-card">
            <h3 style="margin-bottom: 1.5rem; color: var(--text);">Ejemplo de Entrega</h3>
            
            <div style="margin-bottom: 1.5rem;">
              <h4 style="font-size: 1rem; color: var(--accent); margin-bottom: 0.5rem;">Tendencia de Precipitaciones (Trimestre JJA)</h4>
            ...
            <div style="margin-bottom: 1.5rem; padding-top: 1.5rem; border-top: 1px solid var(--border);">
              <h4 style="font-size: 1rem; color: var(--accent); margin-bottom: 0.5rem;">Tendencia de Temperaturas Mínimas (Trimestre JJA)</h4>
              <p style="font-size: 0.9rem; color: var(--muted);">
