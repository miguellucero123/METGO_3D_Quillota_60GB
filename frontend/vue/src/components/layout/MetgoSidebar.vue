...
const gruposDef = [
  ...
  },
  {
    ...
    items: [
      { to: '/cuenta', label: 'Suscripción activa', icon: UserCog, requiresAuth: true },
      { to: '/preferencias', label: 'Preferencias', icon: Settings, requiresAuth: true },
      { to: '/configuracion', label: 'Configuración', icon: Wrench },
    ],
  },
]
