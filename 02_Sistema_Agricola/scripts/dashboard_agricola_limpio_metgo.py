"""
DASHBOARD AGRÍCOLA LIMPIO - METGO 3D QUILLOTA
Versión completamente limpia sin warnings de Plotly
"""
...
st.set_page_config(
    page_title="METGO 3D - Dashboard Agrícola Limpio",
    page_icon="🌱",
    layout="wide",
    initial_sidebar_state="expanded"
)

class DashboardAgricolaLimpio:
    def __init__(self):
    ...
    def _mostrar_graficos_temperatura(self, datos_reales):
        ...
        if estaciones:
            ...
            # Configuración de Plotly para eliminar warnings
            config_plotly = {
            ...
            st.plotly_chart(fig_temp, width='stretch', config=config_plotly)
            ...
            st.plotly_chart(fig_scatter, width='stretch', config=config_plotly)
    ...
    def ejecutar(self):
        ...
        # Header principal
        st.title("🌱 METGO 3D - Dashboard Agrícola Limpio")
        st.markdown("**Sistema Integral de Gestión Agrícola para el Valle de Quillota - Sin Warnings**")
        st.markdown("---")
        ...
        if st.session_state.datos_reales_apis:
            ...
            st.subheader("🌱 Sistema de Gestión Agrícola METGO 3D - Versión Limpia")
            ...
            with col1:
                ...
                **Funcionalidades Principales:**
                ...
                - 📈 Visualizaciones interactivas SIN WARNINGS
                """)
...
def main():
    dashboard = DashboardAgricolaLimpio()
    dashboard.ejecutar()
