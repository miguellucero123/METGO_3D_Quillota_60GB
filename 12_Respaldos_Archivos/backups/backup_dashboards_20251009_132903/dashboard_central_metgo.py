...
Página central de acceso a todos los dashboards del sistema
Incluye: Navegación unificada, estado de dashboards, y gestión centralizada
"""
    ...
    def __init__(self):
        self.dashboards = {
            'dashboard_empresarial': {
                ...
                'descripcion': 'Vista ejecutiva con métricas empresariales y KPIs',
                'icono': '📊',
            ...
            'dashboard_agricola': {
                ...
                'descripcion': 'Gestión completa de cultivos, producción y recomendaciones',
                'icono': '🌱',
            ...
            'dashboard_meteorologico': {
                ...
                'descripcion': 'Monitoreo climático en tiempo real y pronósticos',
                'icono': '🌤️',
            ...
            'dashboard_drones': {
                ...
                'descripcion': 'Monitoreo aéreo, análisis de cultivos y detección de problemas',
                'icono': '🚁',
            ...
            'sistema_economico': {
                ...
                'descripcion': 'Análisis de ROI, costos y rentabilidad en tiempo real',
                'icono': '💰',
            ...
            'reportes_avanzados': {
                ...
                'descripcion': 'Generación de reportes PDF y análisis comparativos',
                'icono': '📈',
            ...
            'base_datos_historica': {
                'nombre': 'Base de Datos Histórica',
                'descripcion': 'Datos históricos de 5 años y análisis de tendencias',
                'icono': '🗄️',
    ...
    def iniciar_dashboard(self, dashboard_id):
        ...
        try:
            ...
            if dashboard['puerto'] is None:
                return False, "Este módulo no requiere servidor web"
    ...
    def detener_dashboard(self, dashboard_id):
        ...
        try:
            if dashboard_id in self.procesos_activos:
                ...
                return False, "Dashboard no está activo"
        except Exception as e:
            return False, f"Error: {e}"
...
def render_dashboard_central():
    ...
    <div class="dashboard-header">
        ...
        <p class="dashboard-subtitle">Sistema de Gestión Agrícola Inteligente - Dashboard Central</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        if st.button("🛑 Detener Todos", width='stretch'):
        ...
        if st.button("🚀 Iniciar Todos", width='stretch'):
        ...
        st.metric("Estado Sistema", "🟢 Operativo" if dashboards_activos > 0 else "🔴 Detenido")
    ...
    with col3:
        ...
        <div class="stat-item">
            ...
            <div class="stat-label">Módulos Sistema</div>
        </div>
        """, unsafe_allow_html=True)
    
    with col4:
        estado_sistema = "🟢" if dashboards_activos > 0 else "🔴"
        st.markdown(f"""
        <div class="stat-item">
        ...
        with cols[i % 2]:
            ...
            with col_btn1:
                if dashboard['estado'] == 'activo':
                    if st.button(f"🌐 Abrir", key=f"open_{dashboard_id}", width='stretch'):
                        if dashboard['puerto']:
                    ...
                    if st.button(f"🚀 Iniciar", key=f"start_{dashboard_id}", width='stretch'):
                        success, message = central_system.iniciar_dashboard(dashboard_id)
                        if success:
                            st.success(message)
                        else:
            ...
            with col_btn2:
                if dashboard['estado'] == 'activo':
                    if st.button(f"🛑 Detener", key=f"stop_{dashboard_id}", width='stretch'):
                    ...
                    if st.button(f"📄 Ejecutar", key=f"run_{dashboard_id}", width='stretch'):
    ...
    with col_info1:
        st.markdown("### 🔐 Información de Autenticación")
        st.info("""
        **Usuarios de Prueba:**
    ...
    with col_info2:
        ...
        4. **Navega** por el dashboard específico
        5. **Detén** cuando termines de usar
        """)
...
def main():
    """Función principal del dashboard central"""
